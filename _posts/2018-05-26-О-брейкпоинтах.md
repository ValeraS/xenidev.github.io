...
category: разработка
thumbnail: "/img/notes/posts/alice.gif"
image: "/img/notes/posts/alice.gif"
---
...
<b>1. Breakpoints стандартные </b>
    1. Breakpoints стандартные для fluid images.
    2. Breakpoints стандартные когда немного все запутанно
<b>2. Breakpoints стандартные для  Bootstrap 3.x</b>
    1. Breakpoints стандартные для fluid images.
    2. Breakpoints стандартные когда немного все запутанно
<b>3. Breakpoints стандартные для  Bootstrap 4.x</b>
<b>4. Retina Breakpoints(@2x)</b>
<b>5. The Material Design Lite (MDL) Breakpoints </b>
